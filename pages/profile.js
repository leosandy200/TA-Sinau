  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.containerCenter}>
        <div className={stylesProfile["upper-container"]}>
          <div className={stylesProfile["upper-container-left"]}>
            <img style={{width: "180px", height: "180px", }} src="/img/profile.png"   />
            {/* <form>
              <input type="file"/>
            </form> */}
          </div>
          <div className={stylesProfile["upper-container-center"]}>
            <h2 className={stylesProfile["upper-container-primary-text"]}>{user.nama}</h2>
            <p className={stylesProfile["upper-container-secondary-text"]}>{user.namaUser}</p>
            <div>
              <img/>
              <p className={stylesProfile["upper-container-secondary-text"]}>Bergabung Oktober 2022</p>
            </div>
            <div>
              <img/>
              <p className={stylesProfile["upper-container-secondary-text"]}>0 Mengikuti / 0 Pengikut</p>
            </div>
          </div>
          <a className={stylesProfile["upper-container-right"]}>
